      ...
      if (quiz) {
        ...
        qs.forEach(function (q, i) {
          ...
          var opts = (q.options || []).map(function (op) {
            return '<label class="vr-option-label"><input type="radio" name="' + key + '" value="' + op.charAt(0) + '" class="mt-0.5 text-blue-600">'
              + '<span class="text-xs text-slate-700">' + op + '</span></label>';
          }).join('');
